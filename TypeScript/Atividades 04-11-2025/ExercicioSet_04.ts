//Escreva um programa para criar uma Collection Set do tipo number, inicializada com 10 valores 
...
pesquisa = readlinesync.questionInt("Digite o numero que deseja encontrar: ");

if (numeros.has(pesquisa)) {
    console.log(`O numero ${pesquisa} foi encontrado!`);
} else {
